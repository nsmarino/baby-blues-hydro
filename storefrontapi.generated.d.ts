...
export type WysiwygQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type WysiwygQuery = {
...
> & {
  ...
  images: {
    nodes: Array<
      Pick<StorefrontAPI.Image, 'id' | 'url' | 'altText' | 'height' | 'width'>
    >;
  };
...
export type ProductDataFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle'
> & {
  priceRange: {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query Wysiwyg($handle: String!) {\n    metaobject(handle: {handle: $handle, type: "wysiwyg"}) {\n      fields {\n        key\n        value\n      }\n    }\n  }\n': {
    return: WysiwygQuery;
    variables: WysiwygQueryVariables;
  };
